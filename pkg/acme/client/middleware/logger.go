...
func (l *Logger) RevokeAuthorization(ctx context.Context, url string) error {
	l.log.V(logf.TraceLevel).Info("Calling RevokeAuthorization")

	return l.baseCl.RevokeAuthorization(ctx, url)
}
